...
import { StudentChecklistView } from '@/components/dashboard/educator/student-checklist-view';
...
export function TripDetails({ tripId }: { tripId: string }) {
  ...
  if (trip === null) {
    return <p className="p-12 uppercase font-body tracking-wider">Loading trip details...</p>;
  }
